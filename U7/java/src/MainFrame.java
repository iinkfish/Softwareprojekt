...
public class MainFrame extends JFrame {
    ...
    // InputStreamReader(socket.getInputStream())); // reading from wifi
    // // module
    // BufferedWriter writer = new BufferedWriter(new
    // OutputStreamWriter(socket.getOutputStream())); // writing to wifi
    // // module
    // // PrintWriter pr = new PrintWriter(socket.getOutputStream());
    // InputStreamReader r = new InputStreamReader(System.in); // reading from
    // terminal
